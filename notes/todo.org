@TODO: need to yank out the notes.org and some other stuff 

@TODO: showcase UI and audio
- get UI scroll regions
- get UI labels

- @TODO: showcase metaprogramming by generating a struct for global variables.
  will need to make directory and file
  Will need to do that step _before_ compiling yikes! 

- @TODO: software renderer! 

- What are the major pain-points
  No UI system
  Text size not uniform. No good layout for text. 
